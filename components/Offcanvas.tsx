...
const Offcanvas: React.FC = () => {
  return (
    <div className="tp-offcanvas-2-area p-relative offcanvas-2-black-bg">
        ...
        <div className="tp-offcanvas-2-left left-box">
          <div className="tp-offcanvas-2-left-wrap d-flex justify-content-between align-items-center">
            <div className="tp-offcanvas-2-logo">
              <a href="/">
                <img className="logo-1" data-width="150" src="/assets/img/logo/logo-white-2.png" alt="" />
                <img className="logo-2" data-width="150" src="/assets/img/logo/logo-black.png" alt="" />
              </a>
            </div>
            <div className="tp-offcanvas-2-close d-md-none text-end">
              <button className="tp-offcanvas-2-close-btn">
        ...
        <div className="tp-offcanvas-2-right right-box d-none d-md-block p-relative">
              ...
              <span className="d-inline-block">
                <span>
                  <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.80859 9.80762L28.1934 28.1924" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M9.80859 28.1924L28.1934 9.80761" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  </svg>
                </span>
              </span>
            </button>
          ...
          <div className="tp-offcanvas-2-right-info-box mt-160">
            ...
            <div className="tp-offcanvas-2-right-info-item">
              ...
              <a className="underline-white" href="tel:42345678910">+4 (234) 567 8910</a>
            </div>
            <div className="tp-offcanvas-2-right-info-item">
              <label className="mb-10">Email</label>
              <a className="underline-white" href="mailto:hello@gmail.com">hello@gmail.com</a>
            </div>
            <div className="tp-offcanvas-2-right-info-item">
              <label className="mb-10">Address</label>
              <a className="underline-white" href="https://www.google.com.bd/maps/@23.7806365,90.4193257,12z?entry=ttu&g_ep=EgoyMDI1MDQwOS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer">
