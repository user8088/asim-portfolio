            ...
            <div className="tp-portfolio-sa-title-wrap mb-40 tp-panel-pin">
              ...
              <div className="tp-rounded-btn-wrap tp-about-wd-btn tp_fade_anim" data-delay=".5" data-fade-from="top" data-ease="bounce">
                <div className="btn_wrapper d-inline-block">
                  <a href="/portfolio" className="tp-btn-rounded btn-item">
            ...
            <div className="tp-portfolio-pp-item-wrap">
              <div className="tp-portfolio-2-item mb-65 tp-panel-pin tp-bg-common-black">
                <div className="not-hide-cursor" data-cursor="View<br>Demo">
                  <a href="/portfolio-details" className="d-block tp-portfolio-2-thumb mb-20 cursor-hide">
                ...
                <div className="tp-portfolio-2-content tp-portfolio-pp-content d-flex justify-content-between align-items-start">
                  <div className="mb-5">
                    <h3 className="tp-portfolio-title fw-700 fs-25 lh-36 mb-10 mr-20"><a className="underline-black" href="/portfolio-details">Innovation in Every Swipe</a></h3>
              ...
              <div className="tp-portfolio-2-item mb-65 tp-panel-pin tp-bg-common-black">
                ...
                <div className="tp-portfolio-2-content tp-portfolio-pp-content d-flex justify-content-between align-items-start">
                  <div className="mb-5">
                    <h3 className="tp-portfolio-title fw-700 fs-25 lh-36 mb-10 mr-20"><a className="underline-black" href="/portfolio-details">Turning Clicks Into Conversions</a></h3>
                    <div className="tp-portfolio-tag positions">
                      <span>UI/UX Design</span>
                    </div>
                  </div>
              ...
              <div className="tp-portfolio-2-item mb-65 tp-panel-pin tp-bg-common-black">
                ...
                <div className="tp-portfolio-2-content tp-portfolio-pp-content d-flex justify-content-between align-items-start">
                  <div className="mb-5">
                    <h3 className="tp-portfolio-title fw-700 fs-25 lh-36 mb-10 mr-20"><a className="underline-black" href="/portfolio-details">Crafting Digital Experiences</a></h3>
                    <div className="tp-portfolio-tag positions">
                      <span>UI/UX Design</span>
                    </div>
                  </div>
